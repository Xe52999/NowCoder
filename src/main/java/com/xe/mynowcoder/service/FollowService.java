...
@Service
public class FollowService implements NowCoderConstant {
    ...
    public long findFolloweeCount(int userId, int entityType) {
        String followeeKey = RedisKeyUtil.getFollowKey(userId, entityType);
    ...
    public List<Map<String, Object>> findFollowees(int userId, int offset, int limit) {
        String followeeKey = RedisKeyUtil.getFollowKey(userId, ENTITY_TYPE_USER);
